...
{{< note >}}
These instructions only apply to CorDapp Contract `.jar` files (unless otherwise stated).
{{< /note >}}
...
Network Map Service, you should manually send the hashes of the two `.jar` files to the CZ network operator and request these be added using
